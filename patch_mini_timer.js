...
const startStr = "function createMiniTimerBubble(user, state) {";
const endStr = "  return div;\n}";
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  return div;
    ...
    code = code.substring(0, startIndex) + newBubble + code.substring(endIndex);
    fs.writeFileSync("script.js", code);
    console.log("Success modifying bubble");
} else {
    console.log("Error finding bubble function");
}
